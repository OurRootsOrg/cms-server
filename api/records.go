...
func (api API) GetRecord(ctx context.Context, id string) (*model.Record, *model.Errors) {
...
func (api API) AddRecord(ctx context.Context, in model.RecordIn) (*model.Record, *model.Errors) {
	...
	if err == persist.ErrForeignKeyViolation {
		...
		return nil, model.NewErrors(http.StatusBadRequest, model.NewError(model.ErrBadReference, in.Post, "post"))
	} else if err != nil {
...
func (api API) UpdateRecord(ctx context.Context, id string, in model.Record) (*model.Record, *model.Errors) {
	err := api.validate.Struct(in)
	if err != nil {
		return nil, model.NewErrors(http.StatusBadRequest, err)
	}
