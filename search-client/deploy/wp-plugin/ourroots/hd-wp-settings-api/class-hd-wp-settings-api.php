...
if ( ! class_exists( 'OURROOTS_WP_Settings_API' ) ) :
/**
 * WordPress Settings API Wrapper Class
 *
 * @version 1.1
 ...
 */
class OURROOTS_WP_Settings_API {
	...
	/**
	 * Holds instance of OURROOTS_HTML_Helper class
	 * @var object
	 */
	var $html_helper;
	...
	function __construct( $options = array(), $fields = array() ) {
		...
		$this->html_helper = class_exists( 'OURROOTS_HTML_Helper' ) ? new OURROOTS_HTML_Helper : false;
	...
	function register_options() {
		...
		foreach ( $this->fields as $field_setting => $field ) {
			...
			} elseif ( in_array( $field['type'], array( 'number', 'text', 'password', 'textarea', 'select', 'checkbox', 'radio', 'multiselect', 'multicheck', 'upload', 'color', 'editor' ) ) ) {
	...
	function settings_page() {
		...
		<div class="wrap <?php echo sanitize_html_class( $this->options['menu_slug'] ); ?>">
            ...
            <div>Manage your database content at <a href="https://cms.ourroots.org">cms.ourroots.org</a></div>
