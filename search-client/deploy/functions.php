...
function ourroots_cms_load_scripts() {
    if ( is_page_template('ourroots_cms.php') ) {
        wp_enqueue_style('ourroots_cms_main_css', get_stylesheet_directory_uri() . '/ourroots_cms/main.css', array(), '0.0.2');
        wp_enqueue_script('ourroots_cms_main_js', get_stylesheet_directory_uri() . '/ourroots_cms/main.js', array(), '0.0.2', true);
        wp_enqueue_script('ourroots_cms_first_js', get_stylesheet_directory_uri() . '/ourroots_cms/2.fc5da061.chunk.js', array(), '0.0.2', true);
        wp_enqueue_script('ourroots_cms_second_js', get_stylesheet_directory_uri() . '/ourroots_cms/main.9461f796.chunk.js', array(), '0.0.2', true);
    }
}
...
function ourroots_search_load_scripts() {
    if ( is_page_template('ourroots_search.php') ) {
        ...
        wp_enqueue_style('ourroots-search-css-about', get_stylesheet_directory_uri() . '/ourroots_search/css/about.bf9233c5.css', array(), '0.0.1');
        wp_enqueue_style('ourroots-search-css-chunk-vendors', get_stylesheet_directory_uri() . '/ourroots_search/css/chunk-vendors.4956c3de.css', array(), '0.0.1');
        wp_enqueue_style('ourroots-search-css-app', get_stylesheet_directory_uri() . '/ourroots_search/css/app.d6587fa0.css', array(), '0.0.1');
    	wp_enqueue_script('ourroots-search-js-about', get_stylesheet_directory_uri() . '/ourroots_search/js/about.089c8d85.js', array(), '0.0.1');
	    wp_enqueue_script('ourroots-search-js-chunk-vendors', get_stylesheet_directory_uri() . '/ourroots_search/js/chunk-vendors.760b180b.js', array(), '0.0.1', true);
        wp_enqueue_script('ourroots-search-js-app', get_stylesheet_directory_uri() . '/ourroots_search/js/app.7a079323.js', array(), '0.0.1', true);
    }
}
